...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    Route::get('/customerservice', 'Front\FrontendController@customerservice')->name('front.customerservice');
    Route::get('/servicestatus', 'Front\FrontendController@servicestatus')->name('front.servicestatus');
    ...
    Route::post('/foster/cancle', 'Front\FosterController@cancle')->name('foster.cancle');
