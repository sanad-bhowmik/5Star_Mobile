 ...
 */
    $arrival =  Product::where('is_arrival',1)
    ->orderByDesc('id')
    ->limit(4)
    ->get();
    ...
    return view('front.index',compact('ps','sliders','services','top_small_banners','feature_products','arrival'));
...
// -------------------------------- PRINT SECTION ENDS ----------------------------------------
    ...
    public function servicestatus(Request $request){
        ...
        $jobcode= $request->jobCode =="" ? 0 : $request->jobCode;
        $receivingCode= $request->receivingCode=="" ? 0 : $request->receivingCode;

        


        $url ="http://203.83.162.66:8093/api/FiveStarService?jobCode=".$jobcode."&receivingCode=".$receivingCode."";
        $curl = curl_init($url);
      ...
      //  $data = json_decode($resp);
        ...
        return view('front.customerservicelist',compact('lists')) ;
