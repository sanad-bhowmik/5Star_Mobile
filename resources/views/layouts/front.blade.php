				...
				<div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
					<nav hidden>
						...
						<ul class="menu">
							...
							@endforeach
							-->
							<li><a href="{{ route('front.aboutus') }}">{{ $langg->lang533 }}</a></li>
							<li><a href="{{ route('front.category','phones') }}">{{ $langg->lang531 }}</a></li>
							<li><a href="{{ route('front.category','accessories') }}">{{ $langg->lang532 }}</a></li>
							
							@if($gs->is_contact == 1)
							<li><a href="{{ route('front.contact') }}">{{ $langg->lang20 }}</a></li>
							@endif

							<li><a href="{{ route('front.customerservice') }}">Customer Service</a></li>
							<li>
								<a href="javascript:;" data-toggle="modal" data-target="#track-order-modal" class="track-btn">{{ $langg->lang16 }}</a>
							</li>
							<li>
								<a href="https://webmail.5starmobiles.com.bd"  class="track-btn">Web Mail</a>
							</li>
