					...
					<div class="body-area" id="modalEdit">
						...
						<form id="dasform" action="{{route('admin-prod-update',$data->id)}}" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-lg-7">
									...
									<div class="checkbox-wrapper">
										<input type="hidden" name="product_condition_check" class="checkclick" id="conditionCheck" value="1" {{ $data->product_condition != 0 ? "checked":"" }}>
							...
							<div class="col-lg-4">
								...
								<div class="col-lg-7">
							<div class="checkbox-wrapper">
										<input  type="checkbox" name="arrival" class="" value="1" {{ $data->is_arrival==1 ? "checked":"" }}> 
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<ul class="list">
										<li>
											<input name="size_check" type="hidden" id="size-check" value="1" {{ !empty($data->size) ? "checked":"" }}>
											...
											<div class="feature-tag-top-filds" id="bonus-section">
												...
												<div class="feature-area">
													...
													<div class="row">
														...
														<div class="col-lg-6">
														Referral User Discount:<input type="number" name="referral_user_bonus" class="input-field" placeholder="{{ __('Enter Referral User Discount') }}" min="0" value="{{ $data->referral_user_bonus}}" required="">
														</div>
													</div>
												</div>
												...
												<div class="feature-area">
													...
													<div class="row">
														...
														<div class="col-lg-6">
															<input type="number" name="referral_user_bonus" class="input-field" placeholder="{{ __('Enter Referral User Discount') }}" min="0" value="0" required="">
														</div>
													</div>
												</div>
...
<!-- 							<div class="row">
							...
							<div class="row">
								...
								<div class="col-lg-7">
									...
									<textarea rows="4" cols="50" name="short_description">{{$data->short_description}}</textarea>
								</div>
							</div>
						...
						<div class="col-sm-8">
							<div class="">
								<form method="POST" enctype="multipart/form-data" id="form-gallery">
									...
									Gallery <input type="radio" name="type" value="gallery" checked> 	&nbsp;	&nbsp;
									Banner <input type="radio" name="type" value="bannerGallery">	&nbsp;	&nbsp;
