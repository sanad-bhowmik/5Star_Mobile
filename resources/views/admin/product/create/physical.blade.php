				...
				<div class="product-description">
					<div class="body-area" id="modalEdit">
						...
						<form id="dasform" action="{{route('admin-prod-store')}}" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-lg-7">
									...
									<div class="checkbox-wrapper">
										<input  type="hidden" name="product_condition_check" class="checkclick" id="conditionCheck" value="1">
							...
							<div class="col-lg-4">
									<div class="left-area">
										<h4 class="heading">{{ __('New Arrival ?') }}</h4>
									</div>
								</div>
								<div class="col-lg-7">
							<div class="checkbox-wrapper">
										<input  type="checkbox" name="arrival" class=""  value="1"> 
										<label >{{ __('Check if it is Arrival') }}</label>
									</div>
							</div>
						</div>
							...
							<!-- new banner gallary start  -->
							<input type="file" name="bannerGallery[]" class="hidden" id="uploadgallery2" accept="image/*" multiple>
							<div class="row">
								<div class="col-lg-4">
									<div class="left-area">
										<h4 class="heading">
											{{ __('Product Banner Gallery') }} *
										</h4>
									</div>
								</div>
								<div class="col-lg-7">
									<a href="#" class="set-gallery" data-toggle="modal" data-target="#setBannerGallery">
										<i class="icofont-plus"></i> {{ __('Set Banner Gallery') }}
									</a>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<ul class="list">
										<li>
											<input name="size_check" type="hidden" id="size-check" value="1">
											...
											<div class="feature-tag-top-filds" id="bonus-section">
												<div class="feature-area">
													...
													<div class="row">
														...
														<div class="col-lg-6">
														Referral User Discount:<input type="number" name="referral_user_bonus" class="input-field" placeholder="{{ __('Enter Referral User Discount Amount') }}" min="0" />
														</div>
													</div>
												</div>
											</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
										...
										<textarea rows="4" cols="50" name="short_description"></textarea>
...
<div class="modal fade" id="setBannerGallery" tabindex="-1" role="dialog" aria-labelledby="setBannerGallery" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalCenterTitle">{{ __('Banner Gallery') }}</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">×</span>
				</button>
			</div>
			<div class="modal-body">
				<div class="top-area">
					<div class="row">
						<div class="col-sm-6 text-right">
							<div class="upload-img-btn">
								<label for="image-upload" id="prod_banner_gallery"><i class="icofont-upload-alt"></i>{{ __('Upload File') }}</label>
							</div>
						</div>
						<div class="col-sm-6">
							<a href="javascript:;" class="upload-done" data-dismiss="modal"> <i class="fas fa-check"></i> {{ __('Done') }}</a>
...
<script type="text/javascript">
	...
	$(document).on('click', '#prod_banner_gallery', function() {
		$('#uploadgallery2').click();
		$('.selected-image2 .row').html('');
		$('#dasform').find('.removegalbanner').val(0);
	});
	...
	$("#uploadgallery2").change(function() {
		...
		for (var i = 0; i < total_file; i++) {
			$('.selected-image2 .row').append('<div class="col-sm-6">' +
				'<div class="img gallery-img">' +
				'<span class="remove-img"><i class="fas fa-times"></i>' +
				'<input type="hidden" value="' + i + '">' +
				'</span>' +
			...
			$('#dasform').append('<input type="hidden" name="galvalbanner[]" id="galvalbanner' + i + '" class="removegalbanner" value="' + i + '">')
		}
	});
