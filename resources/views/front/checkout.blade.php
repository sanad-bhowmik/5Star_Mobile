...
<!-- Breadcrumb Area End -->
	...
	<section class="checkout">
		...
		<form id="twocheckout" action="" method="POST" class="checkoutform">
												...
												<div class="row">
													<div class="col-lg-12">
														...
														@endif
															...
															<!-- <a class="nav-link payment" data-val="foster" data-show="no" data-form="{{route('foster.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'ssl','slug2' => 0]) }}" id="v-pills-tab13-tab" data-toggle="pill" href="#v-pills-tab13" role="tab" aria-controls="v-pills-tab13" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
			...
			<input  style="display:block;" type="checkbox"  id="terms_check"><a href="#">I have read and agree with Terms & Condiditions !!</a>
										...
										<div class="row">
											<div class="col-lg-12 mt-3">
												<div class="bottom-area">
													...
													<button type="submit" id="final-btn" disabled class="mybtn1 d-none">{{ $langg->lang753 }}</button>
												</div>
											</div>
										</div>
									</div>
				...
				{{-- Wallet Area Start--}}
					...
					@if(Auth::check())
						...
						<div class="mt-3 d-none">
							<input class="styled-checkbox d-none" id="wallet" type="checkbox" value="value1">
						...
						<div class="wallet-box mt-3 d-none">
							...
							<form id="wallet-form">
								...
								<!-- <button disabled type="submit">{{ $langg->lang818 }}</button> -->
							</form>
...
// referral code check
	...
	$("#check-rcode-form").on('submit', function (e) {
      ...
      if(ttotal % 1 != 0)
      {
		...
		}); // end refferal code check shows error for auth user
